...
const SideNav = ({ url, userName }) => {
    return (
        <aside className="col-12 col-md-2 order-last order-sm-first bg-less-dark" style={{ height: '100%' }}>
            <nav className="nav nav-pills no-decoration flex-sm-column flex-row p-3 justify-content-md-start justify-content-sm-center" >
